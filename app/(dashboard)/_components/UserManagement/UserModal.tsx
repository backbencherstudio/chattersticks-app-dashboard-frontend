        ...
        <div className="space-y-3 text-[10px] md:text-sm text-gray-700">
          ...
          <div className="flex justify-between mr-2 md:mr-5 border-b-2 py-1">
            <div className="flex flex-col gap-2">
              ...
              <span className="font-bold ml-1">{user.favouriteComics}</span>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <span className="font-bold ">{user.PrimaryDevice}</span>
            </div>
          </div>
          <div className="flex justify-between py-1">
            ...
            <div className="flex flex-col gap-2 mr-10 md:mr-15">
              ...
              <span className="font-bold">{user.lastActive}</span>
            </div>
          </div>
        </div>
      </DialogContent>
